  ...
  return (
    <div className="w-44 bg-slate-100 flex flex-col shadow-md absolute" style={{ top: top, left: left }}>
      ...
      <div className="relative group">
        ...
        <div className="absolute left-full top-0 hidden group-hover:block bg-white shadow-md w-40">
          <div className="flex flex-col">
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.bg2)}>Icebergs</span>
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.bg3)}>Sunset</span>
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.bg4)}>Canyon</span>
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.bg0)}>Bliss</span>
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.matrix3d)}>Matrix 3D</span>
            <span className="hover:bg-blue-500 hover:shadow-md p-4 cursor-pointer block w-full text-sm" onClick={() => handleBackgroundChange(assets.dGit)}>Cave 3D</span>
          </div>
        </div>
      </div>
